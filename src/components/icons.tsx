...
export function HeartsIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M8.5 5C6 5 4 6.9 4 9.3c0 3.2 4.5 6.4 6.5 7.7 2-1.3 6.5-4.5 6.5-7.7C17 6.9 15 5 12.75 5c-1 0-1.7.4-2.12 1C10.2 5.4 9.5 5 8.5 5z" />
      <path d="M17.5 4c1.9.3 3 1.6 3 3.3 0 1.1-.6 2.2-1.4 3.2" />
    </svg>
  )
}
